...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        return f"NEO {self.neofullname} has a diameter of {self.diameter:.3f} km"

        # if self.name is None:
        #     fullnamestr = f"NEO {self.designantion} has a diameter of {self.diameter:.3f} km, with a vecolity of {self.velocity:.2f} km/s."
        # else:
        #     fullnamestr = 
